...
let routes = {
  ...
  'get /login': 'AccountController.getLoginBap',
  'get /login/callback-platform': 'AccountController.getCallbackBap',
  ...
  'post /login/callback-server': 'AccountController.postLoginBAPPlatform',
...
if (process.env.NODE_ENV !== 'production') {
  let routeOnlyUsedInDevelopment = {
    ...
    'get /faker/contacts': 'FakerController.fakeContacts',
