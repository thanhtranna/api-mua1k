...
module.exports = {
    ...
    getAuctions: asyncWrap(async (req, res) => {
        ...
        let auctions = await AuctionRepository.getAuctions(page);
    ...
    searchAuctions: asyncWrap(async (req, res) => {
        ...
        let auctions = await AuctionRepository.searchAuctions(value, page);
        res.ok({ data: auctions });
    }),
    ...
    filterAuctions: asyncWrap(async (req, res) => {
        ...
        let auctions = await AuctionRepository.filterAuctions(type, page, categoryId);
        res.ok({ data: auctions });
    }),
     ...
     * @return {json}
     */
    getAuction: asyncWrap(async (req, res) => {
    ...
    getLogAuctions: asyncWrap(async (req, res) => {
        ...
        let auctions = await AuctionRepository.logAuctions(page, productId);
        res.ok({ data: auctions });
    }),
};
